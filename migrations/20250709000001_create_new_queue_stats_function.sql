-- Create a new queue statistics function with a different name to avoid conflicts
-- This completely avoids the old get_ocr_queue_stats function issues

CREATE FUNCTION get_queue_statistics()
RETURNS TABLE (
